...
def _expected_converted_rate(
    rate_value, from_convention, to_convention, t_start, t_end
):
    from_tf = from_convention.day_count_convention.get_time_fraction(
        t_start, t_end, from_convention.time_fraction_base
    )
    wf = from_convention.interest_convention.get_wf_from_rate(rate_value, from_tf)
    to_tf = to_convention.day_count_convention.get_time_fraction(
        t_start, t_end, to_convention.time_fraction_base
    )
...
def test_convert_rate_convention_compounded_to_exponential():
    ...
    expected = _expected_converted_rate(
        0.06, from_convention, to_convention, t_start, t_end
    )
...
def test_convert_rate_convention_exponential_to_compounded():
    ...
    expected = _expected_converted_rate(
        0.03, from_convention, to_convention, t_start, t_end
    )
...
def test_convert_rate_convention_linear_to_exponential():
    ...
    expected = _expected_converted_rate(
        0.02, from_convention, to_convention, t_start, t_end
    )
...
def test_convert_rate_convention_exponential_to_linear():
    ...
    expected = _expected_converted_rate(
        0.04, from_convention, to_convention, t_start, t_end
    )
